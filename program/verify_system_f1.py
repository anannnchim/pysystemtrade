...
#
# # Unround pandl
# unround_pnl = s.accounts.portfolio(roundpositions=False)
# unround_pnl.to_csv("/Users/nanthawat/PycharmProjects/pysystemtrade/program/output_csv/unround_pnl.csv")
# # Sharpe cost
# s.accounts.pandl_for_subsystem("USD") ## includes both, assuming you're using SR costs
# # price
# s.rawdata.get_daily_prices("S50").to_csv("/Users/nanthawat/PycharmProjects/pysystemtrade/program/output_csv/price.csv")
# # cap multi
# s.portfolio.capital_multiplier().to_csv("/Users/nanthawat/PycharmProjects/pysystemtrade/program/output_csv/cap_multi.csv")
# # position
# s.accounts.portfolio().to_csv("/Users/nanthawat/PycharmProjects/pysystemtrade/program/output_csv/portfolio.csv")
# s.accounts.portfolio_with_multiplier().to_csv("/Users/nanthawat/PycharmProjects/pysystemtrade/program/output_csv/portfolio_multi.csv")
# # curve
# s.accounts.portfolio().curve().to_csv("/Users/nanthawat/PycharmProjects/pysystemtrade/program/output_csv/curve.csv")
# s.portfolio.pandl_across_subsystems().to_csv("/Users/nanthawat/PycharmProjects/pysystemtrade/program/output_csv/pnl.csv")
# # Instru daily return
# s.portfolio.returns_across_instruments_as_df().to_csv("/Users/nanthawat/PycharmProjects/pysystemtrade/program/output_csv/return.csv")
...
if __name__ == '__main__':
    ...
    # pos = pd.DataFrame({
    #     "actual_position": s.portfolio.get_actual_position(c1),
    #     "top_pos": s.portfolio.get_actual_buffers_for_position(c1).iloc[:, 0],
    #     "bot_pos": s.portfolio.get_actual_buffers_for_position(c1).iloc[:, 1]
    # })
    # pos.to_csv("/Users/nanthawat/PycharmProjects/pysystemtrade/program/output_csv/pos.csv")
    ...
    # Deep to _pandl_for_instrument_with_cash_costs

    # Check raw cosst
    s.rawdata.get_raw_cost_data("USD")
    s.rawdata.rolls_per_year("USD") # 4
